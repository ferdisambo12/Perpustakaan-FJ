<div class="col-12">
  <div class="x_panel">
    <div class="x_title">
      <h2>
        <?php if ($kunci=='view_history') {
          // echo "Laporan Jadwal";
        }else{
          // echo "Laporan Penarikan";
        }
        ?>
      </h2>
      <!--  -->
    ...
    <div class="x_content">
      ...
      action="
      <?php if ($kunci=='view_history') {
        echo base_url('home/cari_history');
        }else{
          echo base_url('');
        }
        ?>" method="post">
      ...
      action="
      <?php if ($kunci=='view_history') {
        echo base_url('home/pdf_history');
        }else{
        echo base_url('');
          }
      ...
      action="
      <?php if ($kunci=='view_history') {
        echo base_url('home/excel_history');
          }else{
            echo base_url('');
          }
        ?>" method="post">
